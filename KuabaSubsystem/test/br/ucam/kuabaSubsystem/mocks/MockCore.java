...
public class MockCore implements MofPackage {
	...
	public MockCore(){	
		...
		this.mockAliasType = createMock(AliasType.class);
		 ...
		 * Attributes.0 
		 */
		MofClass modelElement = createMock(MofClass.class);
			//Creating name Attribute.
			Attribute name = createMock(Attribute.class);
			...
			MultiplicityType visibilityMultiplicity = createMock(MultiplicityType.class);
			Attribute visibility = createMock(Attribute.class);
			...
			EnumerationType visibilityKind = createMock(EnumerationType.class);			
		...
		MofClass umlClass = createMock(MofClass.class);
