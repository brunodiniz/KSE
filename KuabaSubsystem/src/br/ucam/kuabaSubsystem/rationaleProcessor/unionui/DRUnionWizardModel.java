 ...
 * @author Bruno
 */
public class DRUnionWizardModel {
 ...
 */
    ...
    public static final String REPOSITORY_SET_PROPERTY = "repositoryListProperty";
//    public static final String BASE_REPOSITORY_PROPERTY = "baseRepositoryProperty";
    public static final String EQUIVALENCES_PROPERTY = "equivalencesProperty";
    
    private DRUnionWizardPanelDescriptor currentPanel;
    ...
    private Set<KuabaRepository> repositorySet = null;
    private KuabaRepository baseRepository = null;
    private EquivalenceRuleManager equivalences = null;
    private KuabaRepository unionResult = null;
    
    
    /**
     * Default constructor.
     */    
    public DRUnionWizardModel() {
     ...
     */    
    DRUnionWizardPanelDescriptor getCurrentPanelDescriptor() {
        return currentPanel;
    }
     ...
     */    
     void registerPanel(Object id, DRUnionWizardPanelDescriptor descriptor) {
     ...
     */    
     boolean setCurrentPanel(Object id) {
        ...
        DRUnionWizardPanelDescriptor nextPanel =
            (DRUnionWizardPanelDescriptor)panelHashmap.get(id);
...
//            throw new WizardPanelNotFoundException();   
        ...
        DRUnionWizardPanelDescriptor oldPanel = currentPanel;
    ...
    public void addPropertyChangeListener(String propertyName,PropertyChangeListener p) {
        propertyChangeSupport.addPropertyChangeListener(propertyName, p);
    }
    ...
    public Set<KuabaRepository> getRepositorySet() {
        return repositorySet;
    }

    public void setRepositorySet(KuabaRepository baseRepository, Set<KuabaRepository> repositorySet) {
        boolean change = false;
        if (this.baseRepository == null || !this.baseRepository.equals(baseRepository)) {
            this.baseRepository = baseRepository;
            change = true;
        }
        
        if (this.repositorySet == null || !this.repositorySet.equals(repositorySet)) {
            this.repositorySet = repositorySet;
            change = true;
        }
        
        if (change) firePropertyChange(REPOSITORY_SET_PROPERTY, null, repositorySet);
    }
...
//    public void setBaseRepository(KuabaRepository baseRepository) {
//        if (this.baseRepository == null || !this.baseRepository.equals(baseRepository)) {
//            firePropertyChange(BASE_REPOSITORY_PROPERTY, this.baseRepository, baseRepository);
//            this.baseRepository = baseRepository;
//        }
//    }
    ...
    public void setEquivalences(EquivalenceRuleManager equivalences) {
        firePropertyChange(EQUIVALENCES_PROPERTY, null, equivalences);
        this.equivalences = equivalences;
    }

    public void setUnionResult(KuabaRepository unionResult) {
